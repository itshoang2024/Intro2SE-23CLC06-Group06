      ...
      try {
        ...
        if (normalizedWords && normalizedWords.length > 0) {
          try {
            ...
            const completeWords = normalizedWords.filter(
            ...
            if (completeWords.length === 0) {
              ...
              console.log(
                "No complete words to submit after validation passed"
              );
            } else {
        ...
        const navigationDelay =
          normalizedWords && normalizedWords.length > 0 ? 1000 : 500;
