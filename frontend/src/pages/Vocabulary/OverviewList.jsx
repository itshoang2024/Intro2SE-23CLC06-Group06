            ...
            {listInfo && (
              <>
                ...
                <section className="overview-list__sample">
                      ...
                      <div className="sample-table">
                        {words.slice(0, 5).map((word) => (
                          <div key={word.id} className="sample-row">
                            <div className="sample-cell sample-term">
                              <strong>{word.term}</strong>
                            </div>
                            <div className="sample-cell sample-phonetics">
                              {word.phonetics}
                            </div>
                            <div className="sample-cell sample-definition">
                              {word.definition}
                            </div>
                          </div>
                        ))}
                  ...
                  <button
                    className="sample-view-button"
                    onClick={() =>
                      (window.location.href = `/vocabulary/view/${listInfo.id}`)
                    }
                  >
                    ...
                    <img
                      src={RightMoreIcon}
                      alt="arrow-icon"
                      className="sapmple-view-button__icon"
                    />
                  </button>
                </section>
                ...
                <section className="overview-list__statistic">
                  ...
                  <div className="overview-list__stat-box">
                    <div className="overview-list__stat-item">
                      ...
                      {listInfo.wordCount} words
                    </div>
                    <div className="overview-list__stat-item">
                      <img src={CategoryIcon} alt="Category" />
                      <span className="label">Category:</span>
                      {listInfo.tags?.map((tag, idx) => (
                        <span key={idx} className="overview-list__tag">
                          {tag}
                        </span>
                      ))}
                    </div>
                    <div className="overview-list__stat-item">
                      ...
                      <span className="label">Estimated Study Time:</span> 10
                      minutes
                    </div>
                    <div className="overview-list__stat-item">
                      <img src={LearnerIcon} alt="Learners" />
                      <span className="label">Learners Completed:</span> 128
                      learners
                    </div>
                  </div>
                  ...
                  <div className="overview-list__actions">
                    ...
                    <button
                      ...
                      onClick={() =>
                        (window.location.href = `/review/${listInfo.id}`)
                      }
                    >
                      Review now
                    </button>
